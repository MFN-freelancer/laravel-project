                    ...
                    <div class="row">
                            ...
                            <div class="course_container">
                                ...
                                <figure>
                                    <a href="fitness-course-1.html">
                                        <img src="{{asset("front_assets/img/course_1.jpg")}}" width="800" height="533" class="img-responsive" alt="Image">
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                            <div class="course_container">
                                ...
                                <figure>
                                    <a href="fitness-course-1.html">
                                        <img src="{{asset("front_assets/img/course_2.jpg")}}" width="800" height="533" class="img-responsive" alt="Image">
                                        <div class="short_info"><i class="icon-clock-1"></i>2 hr 56 min</div>
                                    </a>
                                </figure>
                    ...
                    <div class="row">
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                            <div class="course_container">
                                ...
                                <figure>
                                    <a href="fitness-course-1.html">
                                        <img src="{{asset("front_assets/img/course_3.jpg")}}" width="800" height="533" class="img-responsive" alt="Image">
                                        <div class="short_info"><i class="icon-clock-1"></i>2 hr 56 min</div>
                                    </a>
                                </figure>
                                <div class="course_title">
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                            <div class="course_container">
                                ...
                                <figure>
                                    <a href="fitness-course-1.html">
                                        <img src="{{asset("front_assets/img/course_4.jpg")}}" width="800" height="533" class="img-responsive" alt="Image">
                                        <div class="short_info"><i class="icon-clock-1"></i>2 hr 56 min</div>
                                    </a>
                                </figure>
                                <div class="course_title">
                    ...
                    <div class="row">
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="course_container">
                                ...
                                <figure>
                                    <a href="fitness-course-1.html">
                                        <img src="{{asset("front_assets/img/course_5.jpg")}}" width="800" height="533" class="img-responsive" alt="Image">
                                        <div class="short_info"><i class="icon-clock-1"></i>2 hr 56 min</div>
                                    </a>
                                </figure>
                                <div class="course_title">
                                    ...
                                    <h3><a href="fitness-course-1.html">Fat Burning Butt and Thigh </a></h3>
                                    <div class="info_2 clearfix"><span class="price">39.90<sup>$</sup></span><span class="users">450</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.6s">
                            <div class="course_container">
                                ...
                                <figure>
                                    <a href="fitness-course-1.html">
                                        <img src="{{asset("front_assets/img/course_6.jpg")}}" width="800" height="533" class="img-responsive" alt="Image">
                                        <div class="short_info"><i class="icon-clock-1"></i>2 hr 56 min</div>
                                    </a>
                                </figure>
                                <div class="course_title">
                    ...
                    <div class="row">
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                            <div class="course_container">
                                <figure>
                                    <a href="fitness-course-1.html">
                                        <img src="{{asset("front_assets/img/course_7.jpg")}}" width="800" height="533" class="img-responsive" alt="Image">
                                        <div class="short_info"><i class="icon-clock-1"></i>2 hr 56 min</div>
                                    </a>
                                </figure>
                                <div class="course_title">
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.8s">
                            <div class="course_container">
                                <figure>
                                    <a href="fitness-course-1.html">
                                        <img src="{{asset("front_assets/img/course_8.jpg")}}" width="800" height="533" class="img-responsive" alt="Image">
                                        <div class="short_info"><i class="icon-clock-1"></i>2 hr 56 min</div>
                                    </a>
                                </figure>
                                <div class="course_title">
